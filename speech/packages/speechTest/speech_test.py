...
def create_features(features, words):
    for i in range(0,len(words)):
        ...
        if  words[i][0] in wh_words:
            ...
            features[i] = 2
        elif words[i][1] in pronoun_tags:
            features[i] = 3
        elif words[i][1] in verb_tags:
            features[i] = 4   
        elif words[i][1] in adverb_tags:
            features[i] = 5     
        elif words[i][1] not in wh_words and words[i][1] not in noun_tags and words[i][1] not in pronoun_tags and words[i][1] not in verb_tags:
            features[i] = 6
